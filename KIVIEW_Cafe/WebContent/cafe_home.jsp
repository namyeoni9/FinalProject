...
<body>
	...
	<section class="ftco-section bg-light">
		<div class="container">
			...
			<!-- 카페 리스트 단위 -->
			<span><h3 style="display: inline">가입한 카페</h3>(1)<!-- 카페 수 --></span><span
				style="position: relative; left: 78%"><a href="#">내 카페
					관리</a></span>
			...
			<!-- 카페 리스트 단위 -->
			<span><h3 style="display: inline">운영중 카페</h3>(1)<!-- 카페 수 --></span><span
				style="position: relative; left: 78%"><a href="#">내 카페
					관리</a></span>
			<hr style="margin-top: 5px;">
