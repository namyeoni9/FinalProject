...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
      ...
      <div class="slider-item" style="background-image:url(images/main/main_07.jpg);">
      ...
      <div class="slider-item" style="background-image:url(images/main/main_06.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 text-center ftco-animate">
	...
	<!-- @@ 주석 끝 @@ -->	
		...
		<h1 style = "position: relative; top: 80px; text-align: center;">search bar 들어가는 부분</h1>
		<br><br><br><br><br><br>
